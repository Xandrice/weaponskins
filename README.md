Applies a custom image to a weapon and stores it on the item in ox_inventory. The skin stays on that gun after you holster it, drop it, or restart the server.
